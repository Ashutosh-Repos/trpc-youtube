                ...
                {[1, 2, 3, 4, 5].map((i: number) => (
                    <div key={i} className="flex gap-2">
                        ...
                        <div className="flex flex-col gap-2 w-full py-1">
                            <div className="h-4 bg-surface-2 rounded-lg animate-pulse w-full m-0" />
                            <div className="h-4 bg-surface-2 rounded-lg animate-pulse w-3/4 m-0" />
                            <div className="h-3 bg-surface-2 rounded-lg animate-pulse w-1/2 mt-2" />
                        </div>
                    </div>
                ))}
            </div>
